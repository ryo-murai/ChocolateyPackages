...
$installerType = 'exe'
$url = 'http://hide.maruo.co.jp/software/bin2/hm832_signed.exe'
$url64 = 'http://hide.maruo.co.jp/software/bin/hm832_x64_signed.exe'
$silentArgs = '' # no such parameter. see http://www.maruo.co.jp/hidesoft/2/x30746_.html
$validExitCodes = @(0) 
